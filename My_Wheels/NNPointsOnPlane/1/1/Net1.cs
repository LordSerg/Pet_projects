...
namespace _1
{
    ...
    {//сеть 2-3-1
        ...
        public static void Study(double in1, double in2, double out1)
        {
            ...
            n[5].IN = s[6].Weight * n[2].OUT + s[7].Weight * n[3].OUT + s[8].Weight * n[4].OUT;//
            ...
            n[4].DELTA = s[8].Weight * n[5].DELTA * (1 - n[4].OUT) * n[4].OUT;//
            n[3].DELTA = s[7].Weight * n[5].DELTA * (1 - n[3].OUT) * n[3].OUT;//
            n[2].DELTA = s[6].Weight * n[5].DELTA * (1 - n[2].OUT) * n[2].OUT;//

            //нахождение градиента синапсов:
            s[8].culc_gr(n[5].DELTA, n[4].OUT);//
            s[7].culc_gr(n[5].DELTA, n[3].OUT);//
